defmodule LoggerBackends.HandlerTest do
  use Logger.Case
  @moduletag :logger
  ...
  after
    LoggerBackends.configure(LoggerBackends.Console, metadata: [])
  end
  ...
  test "include Erlang severity level information" do
    LoggerBackends.configure(LoggerBackends.Console, metadata: [:erl_level])
